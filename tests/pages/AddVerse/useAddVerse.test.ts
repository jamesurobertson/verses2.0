...
describe('useAddVerse Hook', () => {
  ...
  describe('addVerse', () => {
    ...
    test('shows loading state during operation', async () => {
      ...
      mockDataService.addVerse.mockReturnValue(addVersePromise);
      ...
      await act(async () => {
        resolveAddVerse!({
          success: true,
          local: {
            verse: { id: '1', reference: 'John 3:16', text: 'text', translation: 'ESV', created_at: '', updated_at: '' },
            verseCard: { id: '1', user_id: '1', verse_id: '1', current_phase: 'daily' as const, phase_progress_count: 0, last_reviewed_at: null, next_due_date: '2024-01-01', archived: false, created_at: '', updated_at: '', current_streak: 0, best_streak: 0 }
          },
          remote: null,
          errors: {}
        });
